// src/lib.rs
/*
 * Core library for GovernancePortal
 */
...
#[derive(Debug)]
pub struct GovernancePortalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GovernancePortalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GovernancePortal processing");
    
    let mut processor = GovernancePortalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GovernancePortalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GovernancePortalProcessor::new(false);
